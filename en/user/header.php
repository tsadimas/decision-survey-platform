...
if (!isset($_SESSION['user']) || (trim($_SESSION['type']) == 'admin')) {
    ...
    $message = "You don't have permissions to view this page, please login first";
...
<body>
    ...
    <div id="templatemo_header_wrapper">
        <div id="templatemo_header">
            ...
            <p id="intro_text"><a href="http://www.hua.gr/index.php/el/" target="_blank">Harokopion University</a> - <a href="http://www.dit.hua.gr/index.php/el/" target="_blank">Department of Informatics and Telematics</a></p>
        </div>
    </div>
